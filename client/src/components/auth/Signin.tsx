                    ...
                    <main className="w-full max-w-md mx-auto p-6">
                        <div className="mt-7 bg-gray-100 border border-gray-200 rounded-xl shadow-sm">
                            <div className="p-4 sm:p-7">
                                ...
                                <div className="mt-5">
                                    <div className="text-center">
                                        <button type="button" className="w-full py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-gray-100 text-gray-700 shadow-sm align-middle hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm">
                                            ...
                                            <div className="grid gap-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="relative">
                                                        <input onChange={handleChange} type="email" id="email" name="email" className="py-3 px-4 block w-full border-gray-300 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 bg-white dark:bg-gray-200 dark:border-gray-300 dark:text-gray-400" required aria-describedby="email-error" />
